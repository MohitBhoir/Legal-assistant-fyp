  ...
  return (
    <section className="w-full h-full dark:bg-gray-900 justify-center flex flex-col ">
      <div className="mt-16 py-8 px-4 mx-auto max-w-screen-4xl text-center lg:py-16 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-20 sm:h-full lg:h-[500px] lg:w-[100rem]">
          {features.map((feature, index) => (
            
              <div
                key={index}
                className="justify-center flex flex-col items-center bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 "
              >
                <img
                  src={feature.image}
                  alt={feature.heading}
                  className="mb-4 w-full h-48 object-contain  rounded-lg"
                />
